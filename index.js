import{a as k,i as y,S as fe}from"./assets/vendor-Cq1ZEsD1.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();const a={burgerBtnOpenMenu:document.querySelector(".icon-burger"),burgerBtnCloseMenu:document.querySelector(".icon-close"),headerMenuContainer:document.querySelector(".header-menu-container"),loaderOverlay:document.querySelector(".loader-in"),modalForm:document.querySelector(".feedback-mod"),stars:document.querySelectorAll(".star-rating path"),nameInput:document.querySelector('.feedback-mod [name="name"]'),messageInput:document.querySelector('.feedback-mod [name="message"]'),modalOverlayArtists:document.querySelector(".modal-overlay-artists"),closeBtn:document.querySelector(".close-btn-mod"),feedbackBtn:document.querySelector(".feedback-btn"),menuAnchorAbout:document.querySelector("#menu-anchor-about"),menuAnchorArtists:document.querySelector("#menu-anchor-artists"),menuAnchorReviews:document.querySelector("#menu-anchor-reviews"),artistsGrid:document.getElementById("artists-card-id"),loadMoreBtn:document.getElementById("load-more-btn"),loader:document.querySelector(".modal-loader"),modalOverlay:document.querySelector(".modal-overlay"),body:document.querySelector("body"),closeModalBtn:document.querySelector(".close-btn"),titleName:document.querySelector(".modal-info-title"),aboutArtist:document.querySelector(".modal-info-card"),modalAlboms:document.querySelector(".modal-alboms"),artistsSection:document.querySelector("#artists-card-id")},ve=8,A="https://sound-wave.b.goit.study/api",Q="/artists",ge="/genres",he="/albums",X="/feedbacks";async function ye(e=1,t="",n="",s=""){const r={limit:ve,page:e,...t&&{name:t},...n&&{sortName:n},...s&&{genre:s}};try{return(await k.get(`${A}${Q}`,{params:r})).data}catch{y.error({title:"Error",message:"Failed to fetch artists.",position:"topRight"})}}async function be(){try{return(await k.get(`${A}${ge}`)).data}catch{y.error({title:"Error",message:"Failed to fetch genres.",position:"topRight"})}}async function Le(e){try{return(await k.get(`${A}${Q}/${e}${he}`)).data}catch{y.error({title:"Error",message:"Failed to fetch albums.",position:"topRight"})}}async function we(e=1){try{return(await k.get(`${A}${X}`,{params:{page:e}})).data}catch{y.error({title:"Error",message:"Failed to fetch feedbacks.",position:"topRight"})}}async function Ee(e){try{return(await k.post(`${A}${X}`,e)).data}catch{y.error({title:"Error",message:"Failed to submit feedback.",position:"topRight"})}}const{loaderOverlay:Z,modalForm:ee,stars:te,nameInput:j,messageInput:Y,modalOverlay:T,closeBtn:ke,feedbackBtn:Ae}=a;function Se(){Z.classList.remove("hidden")}function $e(){Z.classList.add("hidden")}let f=0;te.forEach((e,t)=>{e.addEventListener("mouseenter",()=>{B(t+1)}),e.addEventListener("mouseleave",()=>{B(f)}),e.addEventListener("click",()=>{f=t+1,B(f)})});function B(e){te.forEach((t,n)=>{n<e?t.setAttribute("fill","#a76cdb"):t.setAttribute("fill","#ffffff")})}function Me(){T.classList.add("is-open")}Ae.addEventListener("click",Me);function q(){T.classList.remove("is-open")}ke.addEventListener("click",q);T.addEventListener("click",e=>{e.target===T&&q()});document.addEventListener("keydown",e=>{e.key==="Escape"&&q()});function Be(){let e=!0,t=[];return(j.value.trim().length<2||j.value.trim().length>16)&&(e=!1,t.push("Name must be between 2 and 16 characters")),(Y.value.trim().length<10||Y.value.trim().length>512)&&(e=!1,t.push("Message must be between 10 and 512 characters.")),(f<1||f>5)&&(e=!1,t.push("Rating must be between 1 and 5 stars.")),e||t.forEach(n=>{y.error({title:"Error",message:n,position:"topRight",timeout:3e3,pauseOnHover:!0})}),e}function Ne(){ee.reset(),B(0),f=0}ee.addEventListener("submit",async e=>{if(e.preventDefault(),!Be())return;const t={name:j.value.trim(),rating:f,descr:Y.value.trim()};Se(),await Ee(t),q(),Ne(),$e()});const c="/goit-js-project-work-team-1/assets/sprite-wQKTNHgQ.svg";function Te(e,t=c){const n=Math.floor(e),s=e-n,r=Math.round(s*100);let o="";for(let i=1;i<=5;i++)i<=n?o+=`
          <div class="star">
      ...
      </li>`}function qe(e,t){const n=e.map(s=>{var l;const r=s.strArtistThumb||"https://via.placeholder.com/350x350?text=No+Image",o=s.genres||[],i=((l=s.genres)==null?void 0:l.map(h=>`<li class="genre-tag">${h}</li>`).join(""))||"",g=s.strBiographyEN||"Короткий опис для цього артиста відсутній.";return`
  ...
  <div class="modal-info-description">
            ...
            ${H?`<div class="genres">${H}</div>`:""}
                ...
                `}):x='<p class="no-albums-message">No albums found for this artist.</p>',a.modalAlboms.insertAdjacentHTML("beforeend",x),a.modalOverlayArtists.classList.add("is-open"),a.body.classList.add("no-scroll"),a.closeModalBtn.addEventListener("click",C),a.modalOverlayArtists.addEventListener("click",re),document.addEventListener("keydown",ae),se()}function C(){a.modalOverlayArtists.classList.remove("is-open"),a.body.classList.remove("no-scroll"),a.closeModalBtn.removeEventListener("click",C),a.modalOverlayArtists.removeEventListener("click",re),document.removeEventListener("keydown",ae),se()}a.artistsSection?a.artistsSection.addEventListener("click",e=>{const t=e.target.closest(".artist-card-link");if(t){const n=t.dataset.artistId;let s=[];const r=t.dataset.genres;if(r)try{s=JSON.parse(r)}catch(o){console.error("Error parsing genres from data attribute:",o),s=[]}Ke(n,s)}}):console.warn('Виконавців з ID "artists-card-id" не знайдено.');
